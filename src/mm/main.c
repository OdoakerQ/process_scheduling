 ...
 *			    do_setgproc				       *
 *=====================================================================*/
int do_setgproc(void) {
	message m1 = mm_in;

  /* printf("\nIN_MAIN.c(%d, %d)\n", m1.m1_i1, m1.m1_i2); */
	return _taskcall(SYSTASK, SYS_SETGPROC, &m1);
 ...
 *			    do_getgproc				       *
 *=====================================================================*/
int do_getgproc(void) {
	message m1 = mm_in;

  /* printf("\nIN_MAIN.c(%d)\n", m1.m1_i1); */
	return _taskcall(SYSTASK, SYS_GETGPROC, &m1);
 ...
 *			    do_setgparam				       *
 *=====================================================================*/
int do_setgparam(void) {
	message m1 = mm_in;

	return _taskcall(SYSTASK, SYS_SETGPARAM, &m1);
 ...
 *			    do_getgparam				       *
 *=====================================================================*/
int do_getgparam(void) {
	message m1 = mm_in;

	return _taskcall(SYSTASK, SYS_GETGPARAM, &m1);
