...
struct proc {
  ...
  int p_group; /*  group of user process */
...
#define PROC_GROUP_C     2
#define PROC_GROUP_B     1
#define PROC_GROUP_A     0
#define PROC_GROUPS_NUM  3
