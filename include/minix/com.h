...
#	define SYS_FINDPROC  21	/* fcn code for sys_findproc(name, &task_nr,
				   flags) */
#	define SYS_SETGPROC  22 /* fcn code for sys_setgproc */
#	define SYS_GETGPROC  23 /* fcn code for sys_getgproc */

#	define SYS_SETGPARAM  24 /* fcn code for sys_setgparam */
#	define SYS_GETGPARAM  25 /* fcn code for sys_getgparam */
